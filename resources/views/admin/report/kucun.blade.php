...
@section('menu_list','库存流向')
@section('selecter')
<div id="div_selecter">
    <form action="{{url('/admin/report/kucun')}}" method="get">
...
<div id="div_result">
    ...
    <table class="table table-hover" id="report_table">
        ...
        <thead>
            <tr>
                <th>Branch Store|门店</th>
                <th>店内码</th>
                <th>Product Name|品名</th>
                <th>规格</th>
                <th>单位</th>
                <th>Manufacturing Enterprise|生产单位</th>
                <th>零售价</th>
                <th>数量</th>
            </tr>
        </thead>
    ...
    $('div.pages a').click(function(){
	 ...
	 $("#export").click(function(){
        $("#report_table").table2excel({
            ...
            exclude: ".noExl",
            name: "Worksheet Name",
            filename: "洛阳万家康大药房流向数据表-{{$user->name or ''}}-库存流向.xls" ,//do not include extension
            exclude_img: true,
            exclude_links: true,
            exclude_inputs: true
        });
