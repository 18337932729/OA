...
@section('menu_list','销售流向')
@section('selecter')
<div id="div_selecter">
    <form action="{{url('/admin/report/xiaoshou')}}" method="get">
    ...
    $('div.pages a').click(function(){
	 ...
	 $("#export").click(function(){
        $("#report_table").table2excel({
            ...
            exclude: ".noExl",
            name: "Worksheet Name",
            filename: "洛阳万家康大药房流向数据表-{{$user->name or ''}}-销售明细.xls" ,//do not include extension
            exclude_img: true,
            exclude_links: true,
            exclude_inputs: true
        });
